...
{{% badge color="#7dc903" icon="fa-fw fas fa-puzzle-piece" %}}Relearn{{% /badge %}} This theme allows additional non-standard formatting by setting query parameter at the end of the image URL. The default [behavior is configurable](https://mcshelby.github.io/hugo-theme-relearn/cont/imageeffects/index.html) through your `hugo.toml` or frontmatter parameter.
