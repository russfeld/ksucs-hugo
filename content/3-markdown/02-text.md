...
It is borrowed from the [Hugo Relearn Theme Documentation](https://mcshelby.github.io/hugo-theme-relearn/cont/markdown/). Since the CSS on this site is slightly different, below gives a good overview of the formatting as rendered by this theme.
...
See [Code Highlighting](https://mcshelby.github.io/hugo-theme-relearn/cont/syntaxhighlight/index.html) for additional documentation.
