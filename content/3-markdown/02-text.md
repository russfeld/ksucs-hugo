...
{{% notice note %}}
This page is originally a shameful copy of the great [Grav original page](https://learn.getgrav.org/17/content/markdown).

The current version is borrowed from the [Hugo Relearn Theme Documentation](https://mcshelby.github.io/hugo-theme-relearn/cont/markdown/). Since the CSS on this site is slightly different, below gives a good overview of the formatting as rendered by this theme.
...
{{% badge color="#7dc903" icon="fa-fw fas fa-puzzle-piece" %}}Relearn{{% /badge %}} This theme allows additional non-standard formatting by setting query parameter at the end of the URL. See the [link effects docs](https://mcshelby.github.io/hugo-theme-relearn/authoring/linking/linkeffects) for a detailed example and how to configure it.

#### Target

Add query parameter `target=_self` or `target=_blank` to override [site-wide settings](https://mcshelby.github.io/hugo-theme-relearn/authoring/frontmatter/linking#opening-links) of [the target behavior](https://developer.mozilla.org/en-US/docs/Web/HTML/Element/a#target) individuallly for each link.
...
{{% badge color="#7dc903" icon="fa-fw fas fa-puzzle-piece" %}}Relearn{{% /badge %}} This theme allows additional non-standard formatting by setting query parameter at the end of the image URL. See the [image effects docs](https://mcshelby.github.io/hugo-theme-relearn/authoring/linking/imageeffects) for a detailed example and how to configure it.
