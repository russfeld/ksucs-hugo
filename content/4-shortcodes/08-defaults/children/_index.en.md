...
| **sort**           | see notes         | The sort order of the displayed list.<br/><br/>If not set it is sorted by the [`ordersectionsby`](https://mcshelby.github.io/hugo-theme-relearn/basics/configuration/#global-site-parameters) setting of the site and the pages frontmatter<br/><br/>- `weight`: to sort on menu order<br/>- `title`: to sort alphabetically on menu label. |
